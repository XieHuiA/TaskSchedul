...
public interface JobMapper {
	...
	@Insert("insert into t_job(gmt_create,gmt_modified,guid,desc_ver,group_id,expect_status,conf,creator)"
	...
	@Update("update t_job set creator=${creator} where id=#{id}")
	public void updateById(@Param("id") long id,@Param("creator") String creator);
